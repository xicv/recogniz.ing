...
class AppShellWithDrawer extends ConsumerStatefulWidget {
  const AppShellWithDrawer({super.key});

  @override
  ConsumerState<AppShellWithDrawer> createState() => _AppShellWithDrawerState();
}

class _AppShellWithDrawerState extends ConsumerState<AppShellWithDrawer> {
  @override
  void initState() {
    super.initState();
  }
