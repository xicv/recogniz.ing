...
**Prerequisites**: The app requires a Gemini API key from [Google AI Studio](https://aistudio.google.com/app/apikey) for transcription functionality.
...
│   ├── build-windows.yml          # Windows-specific builds (sub-workflow)
