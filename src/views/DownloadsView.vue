...
const platforms = ref<Platform[]>([
  {
    ...
    downloadUrl: 'https://github.com/xicv/recogniz.ing/releases/download/v1.0.3/recognizing-1.0.3-macos.zip',
    changelog: [
      'Fixed macOS Gatekeeper verification issues',
      'Improved app signing and security',
      'Updated download links for version 1.0.3',
          ...
          <div class="space-y-8">
            <div class="bg-white rounded-lg border border-slate-200 p-8">
              <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-sm text-slate-500">December 21, 2024</span>
              </div>
