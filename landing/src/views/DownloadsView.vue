...
const platforms = ref<Platform[]>([
  {
    name: 'Android',
    icon: 'M17.523 15.341c-.55 0-.99-.45-.99-.99s.45-.99.99-.99c.56 0 .99.45.99.99s-.44.99-.99.99m-11.05 0c-.55 0-.99-.45-.99-.99s.45-.99.99-.99c.56 0 .99.45.99.99s-.44.99-.99.99m11.41-6.02l2.14-3.71c.11-.19.04-.43-.15-.54s-.44-.04-.54.15l-2.17 3.76c-.83.1-1.74-2.39-2.61-4.22-2.61-1.12 0-2.18.29-3.07.8l-2.17-3.76c-.11-.19-.35-.26-.54-.15s-.19.35-.15.54l2.14-3.71c.76-1.44 2.53-2.53 4.22-2.53.06 0 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83',
    version: '1.0.4',
